            ...
            <form action="${ctx}/register" method="post" class="fh5co-form loginbody animate-box fadeInRight animated-fast"
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" name="password_again" placeholder="重复密码" class="form-control" id="repeat-password">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="email" name="email" placeholder="邮箱地址" class="form-control" id="email">
                    </div>
                </div>
